    ...
    <header>
      ...
      <div className='header_content'>
        <div className='header_billboard'>
          <img
            src='https://assets.stickpng.com/thumbs/62038e248c4085000441913b.png'
            alt='billboard'
          />
        </div>
        ...
        executive producers along with Shawn Levy and Dan Cohen. Produced by Monkey 
        Massacre Productions and Levy's 21 Laps Entertainment, the first season was released 
        on Netflix on July 15, 2016."
        </h4>
